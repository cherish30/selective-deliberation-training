...
# Modified by Anonymous Authors, 2026: added gate-step index mapping for selective-thinking rollout.
...
class EnvironmentManagerBase:
    ...
    def _process_batch(self, batch_idx, total_batch_list, total_infos, success):
        ...
        # corresponding entry in total_infos. Build an index mapping.
        info_idx = 0
        batch_to_info: dict = {}
